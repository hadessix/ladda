...
### ตาราง (attendance_migration.sql + attendance_enroll.sql + attendance_viewkey.sql)
...
### ที่ยังไม่ได้ทำ
- [ ] เทียบพิกัดระหว่างเพื่อนร่วมรถ (คนขับ vs เด็กติดรถ ต้องอยู่ใกล้กัน) — ตัวจับโกงที่แรงที่สุด
