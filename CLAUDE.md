...
| `openAttPoints()` | จัดการสติ๊กเกอร์ + คัดลอกลิงก์ไปเขียนลงสติ๊กเกอร์ |
...
**ตรวจอัตโนมัติ (ยังไม่ทำ)** — 210 แถว/วัน ตรวจมือไม่ไหว ต้องให้ระบบคัดมาให้เหลือวันละ 0-3 บรรทัด
1. ห่างจากเพื่อนร่วมรถเกินกำหนด (แตะเวลาใกล้กันแต่พิกัดห่างกันมาก) ← แรงที่สุด
